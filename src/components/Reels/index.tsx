...
function Reels() {
    return (
        <Swiper
            className={`custom-card--darken px-5 custom h-[95vh] tablet:h-[32.5rem] desktop:h-[70rem] tablet:pt-30 desktop:pt-[8rem] pb-8 desktop:pb-[10rem] desktop:min-h-[63rem] mb-6 overflow-hidden w-full swiper-backface-hidden`}
            centeredSlides
            loop
            breakpoints={{
                320: {
        ...
        >
            <SwiperSlide className="rounded-3xl overflow-hidden tablet:w-[95vw] desktop:w-[35rem]">
                <video className="top-0 left-0 min-h-full min-w-full object-cover" preload="auto" loop autoPlay muted playsInline >
