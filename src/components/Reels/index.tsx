...
function Reels() {
    ...
    return (
        <Swiper
            className={`custom ${isMobile ? "" : "container"} h-[95vh] pt-20 pb-8 desktop:pb-[7rem] tablet:h-[32.5rem] desktop:h-[80vh] mb-20 overflow-hidden w-full swiper-backface-hidden`}
